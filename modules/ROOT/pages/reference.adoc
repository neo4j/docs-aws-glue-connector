...
====
**TODO**
<insert details of data type mapping>
====

== Options and configuration
Please refer to the [Neo4j JDBC Driver documentation](https://neo4j.com/docs/jdbc-manual/current/) for all the parameters that are supported within the JDBC URL.
